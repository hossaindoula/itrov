...
<div id="dashboard-left" class="span8">
    ...
    <ul class="shortcuts">
        <li class="events">
            <a href="componentList.itr">
                <span class="shortcuts-icon iconsi-event"></span>
                <span class="shortcuts-label">Component List</span>
            </a>
        </li>
        <li class="prodects">
            <a href="createComponent.itr">
                <span class="shortcuts-icon iconsi-cart"></span>
                <span class="shortcuts-label">Create Component</span>
            </a>
        </li>
    </ul>
    ...
    <div style="margin: 0 auto; width:100%; height:400px; overflow: auto;"><object type="text/html" data="componentListDiv.itr" style="width:100%; height:400px; margin:1%;"></object></div>
